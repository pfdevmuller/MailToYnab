...
# once-off I needed to extract a single month from pdf. It can however be generalized with
# a bit of love. If this is done, a PdfParser should be broken out and specialized for different
# statement formats. The currently implementation also doesn't actually work against PDFs, it
